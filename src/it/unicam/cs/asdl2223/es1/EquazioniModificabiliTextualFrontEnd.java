        ...
        while (!terminate) {
            ...
            do {
                ...
                try {
                    ...
                    if (Math.abs(a) < EPSILON) {
                        ...
                        // MODIFICA: Se il parametro a e' valido, imposta retry a false per non ripetere l'input
                        retry = false;
                    }
                } catch (IOException e) {
            ...
            do {
                ...
                try {
                    ...
                    // MODIFICA: Se il parametro b e' valido, imposta retry a false per non ripetere l'input
                    retry = false;
                } catch (IOException e) {
                    System.err.println("Errore di Input/Output!");
                    System.exit(1);
            ...
            do {
                ...
                try {
                    ...
                    // MODIFICA: Se il parametro c e' valido, imposta retry a false per non ripetere l'input
                    retry = false;
                } catch (IOException e) {
                    System.err.println("Errore di Input/Output!");
                    System.exit(1);
